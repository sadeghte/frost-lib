...
fn main() {
    ...
    //     .with_header("#define FROST_SECP256K1_TR_H")
    //     // Include only specific, C-compatible functions
    //     // .include_item("compute_i32") // Replace with your actual function names
    //     // .include_item("compute_f64")
    //     // Optionally, exclude problematic items explicitly
    //     .exclude_item("my_func_with_va_list") // Replace with any va_list functions
    //     .generate()
    //     .expect("Unable to generate bindings")
    //     .write_to_file(output_file);
    ...
    let header_content = r#"
        ...
        const char* round2_sign_with_tweak(const char* signing_package_buf, const char* signer_nonces_buf, const char* key_package_buf, const char* merkle_root_buf);
        ...
        const char* aggregate_with_tweak(const char* signing_package_buf, const char* signature_shares_buf, const char* pubkey_package_buf, const char* merkle_root_buf);
