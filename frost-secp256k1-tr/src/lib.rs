...
use std::ffi::{
    c_char, // u8 equivalent
    c_ushort, // u16 equuivalent
    c_ulonglong, // u64 equivalent
};
...
#[no_mangle]
pub extern "C" fn get_id(id: *const c_char) -> *const c_char {
	let identifier: Identifier = RET_ERR!(from_json_buff(id));
	RET_ERR!(to_json_buff(&identifier))
}

#[no_mangle]
pub extern "C" fn num_to_id(num: c_ulonglong) -> *const c_char {
    print!("in rust: start");
...
#[no_mangle]
pub extern "C" fn dkg_part1(id: *const c_char, max_signers: c_ushort, min_signers: c_ushort) -> *const c_char {
...
#[no_mangle]
pub extern "C" fn verify_proof_of_knowledge(id: *const c_char, commitments_buff: *const c_char, sign_buff: *const c_char) -> *const c_char {
	let identifier: Identifier = RET_ERR!(from_json_buff(id));
...
#[no_mangle]
pub extern "C" fn dkg_part2(r1_skrt_pkg_buff: *const c_char, r1_pkg_buff: *const c_char) -> *const c_char {
...
#[no_mangle]
pub extern "C" fn dkg_verify_secret_share(id: *const c_char, share_buff: *const c_char, commitment_buff: *const c_char) -> *const c_char {
	let identifier: Identifier = RET_ERR!(from_json_buff(id));
...
#[no_mangle]
pub extern "C" fn dkg_part3(r2_sec_pkg_buf: *const c_char, r1_pkgs_buf: *const c_char, r2_pkgs_buf: *const c_char) -> *const c_char {
...
#[no_mangle]
pub extern "C" fn keys_generate_with_dealer(max_signers: c_ushort, min_signers: c_ushort) -> *const c_char {
	let rng = thread_rng();
...
#[no_mangle]
pub extern "C" fn keys_split(secret_buff: *const c_char, max_signers: c_ushort, min_signers: c_ushort) -> *const c_char {
	let scalar: SerializableScalar = RET_ERR!(from_json_buff(secret_buff));
	let secret: SigningKey = RET_ERR!(SigningKey::from_scalar(scalar.0));
	let mut rng = thread_rng();
...
#[no_mangle]
pub extern "C" fn keys_reconstruct(secret_shares_buff: *const c_char, min_signers: c_ushort) -> *const c_char {
...
#[no_mangle]
pub extern "C" fn get_pubkey(secret_buff: *const c_char) -> *const c_char {
    let scalar: SerializableScalar = RET_ERR!(from_json_buff(secret_buff));
	let secret: SigningKey = RET_ERR!(SigningKey::from_scalar(scalar.0));
...
#[no_mangle]
pub extern "C" fn key_package_from(secret_share: *const c_char) -> *const c_char {
...
#[no_mangle]
pub extern "C" fn round1_commit(secret_buf: *const c_char) -> *const c_char {
...
#[no_mangle]
pub extern "C" fn signing_package_new(signing_commitments_buf: *const c_char, msg: *const c_char) -> *const c_char {
...
#[no_mangle]
pub extern "C" fn round2_sign(signing_package_buf: *const c_char, signer_nonces_buf: *const c_char, key_package_buf: *const c_char) -> *const c_char {
...
pub extern "C" fn round2_sign_with_tweak(
    signing_package_buf: *const c_char, 
    signer_nonces_buf: *const c_char, 
    key_package_buf: *const c_char,
    merkle_root_buf: *const c_char
) -> *const c_char {
	let signing_package: SigningPackage = RET_ERR!(from_json_buff(signing_package_buf));
	let signer_nonces: round1::SigningNonces = RET_ERR!(from_json_buff(signer_nonces_buf));
	let key_package: keys::KeyPackage = RET_ERR!(from_json_buff(key_package_buf));
...
pub extern "C" fn verify_share(
	identifier_buf: *const c_char,
	verifying_share_buf: *const c_char, 
	signature_share_buf: *const c_char, 
	signing_package_buf: *const c_char, 
	verifying_key_buf: *const c_char
) -> *const c_char {
...
#[no_mangle]
pub  extern "C" fn aggregate(signing_package_buf: *const c_char, signature_shares_buf: *const c_char, pubkey_package_buf: *const c_char) -> *const c_char {
...
pub  extern "C" fn aggregate_with_tweak(
    signing_package_buf: *const c_char, 
    signature_shares_buf: *const c_char, 
    pubkey_package_buf: *const c_char,
    merkle_root_buf: *const c_char
) -> *const c_char {
	let signing_package: frost::SigningPackage = RET_ERR!(from_json_buff(signing_package_buf));
	let signature_shares: BTreeMap<Identifier, round2::SignatureShare> = RET_ERR!(from_json_buff(signature_shares_buf));
...
#[no_mangle]
pub  extern "C" fn pubkey_package_tweak(pubkey_package_buf: *const c_char, merkle_root_buf: *const c_char) -> *const c_char {
	let pubkey_package: keys::PublicKeyPackage = RET_ERR!(from_json_buff(pubkey_package_buf));
    let merkle_root: Option<Vec<u8>> = match merkle_root_buf.is_null() {
        true => None,
        false => {
...
#[no_mangle]
pub extern "C" fn key_package_tweak(key_package_buf: *const c_char, merkle_root_buf: *const c_char) -> *const c_char {
	let key_package: keys::KeyPackage = RET_ERR!(from_json_buff(key_package_buf));
    let merkle_root: Option<Vec<u8>> = match merkle_root_buf.is_null() {
        true => None,
        false => {
...
#[no_mangle]
pub extern "C" fn verify_group_signature(signature_buf: *const c_char, msg_buf: *const c_char, pubkey_package_buf: *const c_char) -> *const c_char {
...
#[no_mangle]
pub unsafe extern "C" fn mem_free(ptr: *const c_char) {
