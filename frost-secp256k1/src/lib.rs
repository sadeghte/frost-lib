...
use frost_secp256k1::{
	...
	}, round1, round2::{self, SignatureShare}, Identifier, Secp256K1Sha256, Signature, SigningKey, SigningPackage, VerifyingKey
};
use rand::thread_rng;
...
pub extern "C" fn single_verify(
	...
	let signature: frost_core::Signature<Secp256K1Sha256> = RET_ERR!(from_json_buff(signature_buff));
